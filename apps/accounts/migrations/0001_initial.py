    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Yönetici'), ('manager', 'Müdür'), ('field_worker', 'Saha Görevlisi'), ('accountant', 'Muhasebe'), ('viewer', 'Görüntüleyici')], default='viewer', max_length=20, verbose_name='Rol')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('create', 'Oluşturma'), ('update', 'Güncelleme'), ('delete', 'Silme'), ('view', 'Görüntüleme'), ('approve', 'Onaylama'), ('reject', 'Reddetme')], max_length=20, verbose_name='İşlem')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='İşlem Zamanı')),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', '-created_at'], name='accounts_au_user_id_14f360_idx'), models.Index(fields=['model_name', 'object_id'], name='accounts_au_model_n_76c60d_idx')],
            },
        ),
    ]
